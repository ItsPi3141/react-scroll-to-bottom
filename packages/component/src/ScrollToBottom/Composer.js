...
const Composer = ({
  ...
  const scrollTo = useCallback(
    (nextAnimateTo, { behavior } = {}) => {
      ...
      if (typeof nextAnimateTo !== 'number' && nextAnimateTo !== '100%') {
        return console.warn(
          'react-scroll-to-bottom-updated: Arguments passed to scrollTo() must be either number or "100%".'
        );
      }
      ...
      if (behavior === 'auto') {
        ...
        behavior !== 'smooth' &&
          console.warn(
            'react-scroll-to-bottom-updated: Please set "behavior" when calling "scrollTo". In future versions, the default behavior will be changed from smooth scrolling to discrete scrolling to align with HTML Standard.'
          );
  ...
  const scrollToBottom = useCallback(
    ({ behavior } = {}) => {
      ...
      behavior !== 'smooth' &&
        console.warn(
          'react-scroll-to-bottom-updated: Please set "behavior" when calling "scrollToBottom". In future versions, the default behavior will be changed from smooth scrolling to discrete scrolling to align with HTML Standard.'
        );
  ...
  const scrollToTop = useCallback(
    ({ behavior } = {}) => {
      ...
      behavior !== 'smooth' &&
        console.warn(
          'react-scroll-to-bottom-updated: Please set "behavior" when calling "scrollToTop". In future versions, the default behavior will be changed from smooth scrolling to discrete scrolling to align with HTML Standard.'
        );
  ...
  const scrollToEnd = useCallback(
    ({ behavior } = {}) => {
      ...
      behavior !== 'smooth' &&
        console.warn(
          'react-scroll-to-bottom-updated: Please set "behavior" when calling "scrollToEnd". In future versions, the default behavior will be changed from smooth scrolling to discrete scrolling to align with HTML Standard.'
        );
  ...
  const scrollToStart = useCallback(
    ({ behavior } = {}) => {
      ...
      behavior !== 'smooth' &&
        console.warn(
          'react-scroll-to-bottom-updated: Please set "behavior" when calling "scrollToStart". In future versions, the default behavior will be changed from smooth scrolling to discrete scrolling to align with HTML Standard.'
        );
  ...
  const styleToClassName = useMemo(() => {
    const emotion =
      emotionPool[nonce] ||
      (emotionPool[nonce] = createEmotion({ key: 'react-scroll-to-bottom-updated--css-' + createCSSKey(), nonce }));
